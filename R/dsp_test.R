...
#' @param design Matrix or array. Numeric design matrix for a 
...
#' @param filter_cluster Logical. When set to TRUE, 
...
dsp_test <-  function(spe,
    ...
    if(filter_cluster) {
        ...
        spe <- .filter_clusters_by_pct(spe, condition_col, 
